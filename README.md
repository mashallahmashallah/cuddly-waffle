...
- Buildx cache is pushed/pulled from `ghcr.io/<owner>/<repo>:llama-cpp-buildcache` so CMake/docker layers are persisted in the repo container registry across workflow runs.
